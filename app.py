...
CLIP_LABELS = [
    ...
    "Khajuraho", "Sun Temple Konark", "alai_darwaza", "alai_minar", "basilica_of_bom_jesus",
    "charminar", "golden temple", "hawa mahal pics", "iron_pillar", "jamali_kamali_tomb",
    "lotus_temple", "mysore_palace", "qutub_minar", "tajmahal", "tanjavur temple",
    "victoria memorial"
]
...
if uploaded:
    ...
    3. You get **information about the monument** and a **Google Maps** link.

    > **Supported monuments (24):** Ajanta Caves, Charar-E-Sharif, Chhota Imambara, Ellora Caves, 
    > Fatehpur Sikri, Gateway of India, Humayun's Tomb, India Gate, Khajuraho, Sun Temple Konark, 
    > Alai Darwaza, Alai Minar, Basilica of Bom Jesus, Charminar, Golden Temple, Hawa Mahal, 
    > Iron Pillar, Jamali Kamali Tomb, Lotus Temple, Mysore Palace, Qutub Minar, Taj Mahal, 
    > Tanjavur Temple, and Victoria Memorial.
    """)